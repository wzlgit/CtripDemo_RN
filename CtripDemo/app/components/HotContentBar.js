    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <TitleBar
                    left_text={data.title}
                    right_text={data.descrption} />
    ...
    renderTop(items) {
        return (
            <View style={styles.top}>
                ...
                <View style={{flex:1}}>
                    <Image
                        style={[styles.top_img, {marginBottom:1}]}
                        source={{uri:items.items[0].imageUrl}}
                    />
                    <Image
                        style={styles.top_img}
                        source={{uri:items.items[1].imageUrl}}
                    />
                </View>
            </View>
        )
    ...
    renderBottom(items) {
        return (
            <View style={styles.bottom}>
                <Image
                    style={[styles.top_img, {marginRight:1}]}
                    source={{uri: items.items[2].imageUrl}}
                />
                <Image
                    style={styles.top_img}
                    source={{uri:items.items[3].imageUrl}}
                />
            </View>
        )
    }
